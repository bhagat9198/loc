...
const form8 = async (e) => {
  ...
  const subCat1 = fForm8HTML["f8-subcat1"].value;
  const childCat1 = fForm8HTML["f8-childcat1"].value;
  const cat2 = fForm8HTML["f8-cat2"].value;
  const subCat2 = fForm8HTML["f8-subcat2"].value;
  const childCat2 = fForm8HTML["f8-childcat2"].value;
  const cat3 = fForm8HTML["f8-cat3"].value;
  const subCat3 = fForm8HTML["f8-subcat3"].value;
  const childCat3 = fForm8HTML["f8-childcat3"].value;
  const cat4 = fForm8HTML["f8-cat4"].value;
  const subCat4 = fForm8HTML["f8-subcat4"].value;
  const childCat4 = fForm8HTML["f8-childcat4"].value;
...
const form9 = async (e) => {
  ...
  const subCat1 = fForm9HTML["f9-subcat1"].value;
  const childCat1 = fForm9HTML["f9-childcat1"].value;
  const cat2 = fForm9HTML["f9-cat2"].value;
  const subCat2 = fForm9HTML["f9-subcat2"].value;
  const childCat2 = fForm9HTML["f9-childcat2"].value;
  const cat3 = fForm9HTML["f9-cat3"].value;
  const subCat3 = fForm9HTML["f9-subcat3"].value;
  const childCat3 = fForm9HTML["f9-childcat3"].value;
  const cat4 = fForm9HTML["f9-cat4"].value;
  const subCat4 = fForm9HTML["f9-subcat4"].value;
  const childCat4 = fForm9HTML["f9-childcat4"].value;
